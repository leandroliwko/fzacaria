...
export default function EditarArticuloPage() {
  ...
  useEffect(() => {
    fetch(`/api/articles/${id}`)
      ...
      .catch(() => router.push('/admin/articulos'))
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-navy">Editar Artículo</h1>
          <p className="text-navy-light mt-1">{form.title}</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-cream rounded-xl border border-lavender/30 p-6 shadow-sm">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-sm font-medium text-navy-dark">Publicar</span>
          </label>
        </div>
